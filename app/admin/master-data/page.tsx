...
export default async function MasterDataPage() {
  ...
  const [{ data: doctorRows }, { data: profileRows }] = await Promise.all([
  ...
  const doctorRowsMapped: DoctorMasterRow[] = doctors.map((doctor) => ({
    id: doctor.id,
    name: doctor.name,
        ...
        <div className="container-clinic py-16 lg:py-20">
          ...
          <section className="mt-12">
            ...
            <p className="mt-1 max-w-2xl text-sm text-slate-700">
              A doctor must have a linked login account before their clinic
              presence can show anywhere.
            </p>
            <div className="mt-5">
          ...
          <section className="mt-14">
            ...
            <p className="mt-1 max-w-2xl text-sm text-slate-700">
              Doctors count as staff — they see the clinic schedule as well as
              driving the availability indicator. You can&apos;t change your own
              role; that takes a second administrator.
            </p>
            <div className="mt-5">
